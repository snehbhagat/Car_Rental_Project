...
<?php 
    ...
    $sql="select * from admins where EMAIL='$value'";
        ...
        <div class="navbar">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><img src="images/users/4.jpg" class="circle" alt="Alps"></li>
                    <li><p class="phello">HELLO! &nbsp;<a id="pname"><?php echo "Hello Sir/Mam" ?></a></p></li>
